...
keymap.set('n', '[b', vim.cmd.bprevious,
           {silent = true, desc = 'previous [b]uffer'})
...
keymap.set('n', '[C', vim.cmd.cfirst,
           {silent = true, desc = 'first quickfix entry'})
keymap.set('n', ']C', vim.cmd.clast,
           {silent = true, desc = 'last quickfix entry'})
...
keymap.set('n', '[L', vim.cmd.lfirst,
           {silent = true, desc = 'first [L]oclist entry'})
keymap.set('n', ']L', vim.cmd.llast,
           {silent = true, desc = 'last [L]oclist entry'})
...
keymap.set('n', '<leader>fq', function() vim.cmd('fclose!') end,
...
keymap.set('n', '[e',
           function() diagnostic.goto_prev {severity = severity.ERROR} end, {
    noremap = true,
    silent = true,
    desc = 'previous [e]rror diagnostic'
})
keymap.set('n', ']e',
           function() diagnostic.goto_next {severity = severity.ERROR} end,
           {noremap = true, silent = true, desc = 'next [e]rror diagnostic'})
keymap.set('n', '[w',
           function() diagnostic.goto_prev {severity = severity.WARN} end, {
    noremap = true,
    silent = true,
    desc = 'previous [w]arning diagnostic'
})
keymap.set('n', ']w',
           function() diagnostic.goto_next {severity = severity.WARN} end,
           {noremap = true, silent = true, desc = 'next [w]arning diagnostic'})
keymap.set('n', '[h',
           function() diagnostic.goto_prev {severity = severity.HINT} end,
           {noremap = true, silent = true, desc = 'previous [h]int diagnostic'})
keymap.set('n', ']h',
           function() diagnostic.goto_next {severity = severity.HINT} end,
           {noremap = true, silent = true, desc = 'next [h]int diagnostic'})
...
keymap.set('n', '<leader>S', toggle_spell_check,
...
keymap.set("n", "<C-c>", "<cmd>normal! ciw<cr>a",
           {desc = 'delete word and enter insert mode'})
